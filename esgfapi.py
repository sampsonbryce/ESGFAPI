...
esgfapp = Flask(__name__, template_folder='./src')
...
# @esgfapp.route('/static/bundle.js')
# def root():
#     path = os.path.abspath(os.path.join(os.path.dirname( __file__ ), 'dist/bundle.js'))
#
#     print 'im here yo', path
#
#     return esgfapp.send_static_file(path)
